...
<div id="modal_lgpd">
    <div class="container_modal_lgpd">
        ...
        <div class="texto_modal_lgpd">
            <p>
                N<?=$config->lgpd_conector_nome?> <em><?=$config->lgpd_site_nome?></em>, privacidade e segurança são prioridades e nos comprometemos com a transparência do tratamento de dados pessoais dos nossos clientes.
                <br>
                ...
                <br>
                Se aplica a todos os seus dados coletados pel<?=$config->lgpd_conector_nome?> <em><?=$config->lgpd_site_nome?></em>, por meio do website ou por outros meios. O website d<?=$config->lgpd_conector_nome?> <em><?=$config->lgpd_site_nome?></em> pode conter links de parceiros comerciais ou afiliados, que possuem suas próprias políticas de privacidade, pelas quais <?=$config->lgpd_conector_nome?> <em><?=$config->lgpd_site_nome?></em> não possui qualquer responsabilidade.
                <br>
                <br>
                <b>2. QUEM É RESPONSÁVEL PELOS DADOS PESSOAIS DOS USUÁRIOS?</b>
                <br>
                <span class="uppercase"><?=$config->lgpd_conector_nome?></span> <em><?=$config->lgpd_site_nome?></em> é responsável pelo gerenciamento do website <em><?=$config->lgpd_site_url?></em> e pelos seus dados coletados.
                <br>
                <br>
                <b>3. QUAIS DADOS PESSOAIS PODEM SER COLETADOS PEL<span class="uppercase"><?=$config->lgpd_conector_nome?></span> <em><?=$config->lgpd_site_nome?></em>?</b>
                <br>
                ...
                <br>
                <br>
                <b>4. POR QUAIS MEIOS SEUS DADOS PODEM SER COLETADOS PEL<span class="uppercase"><?=$config->lgpd_conector_nome?></span> <em><?=$config->lgpd_site_nome?></em>?</b>
                <br>
                ...
                <br>
                - Outras entidades do Grupo <em><?=$config->lgpd_site_nome?></em> para fins administrativos internos;
                <br>
                ...
                <br>
                Se você deseja exercer um dos seus direitos, por favor envie um email para <em><?=$config->lgpd_site_email?></em> A/C Marketing.
                <br>
